...
the linear part is dominating.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_43_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
...
to a square section, will have a great impact on the eddy roll damping.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_46_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
...
tree is illustrated in the figure below:
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_67_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
...
\bottomrule 
 \end{longtable}
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_70_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
...
shown in the figure below.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_76_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
...
\(\phi_{n+2}\) * D : \((\phi_n + \phi_{n+1} + \phi_{n+2})/3\)
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_83_0.pdf}\end{center}
        \caption{}
        \label{fig:}
    \end{figure}
