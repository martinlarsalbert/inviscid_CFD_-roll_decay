...
(ref Hess and Smith) to solve the boundary value problem for the
velocity potential.
...
coupled with the mixed Eulerian-Lagrangian method (MEL) (ref
Longuet-Higgins and Cokelet 1976) which is used for the evolution of
free surface. A fourth-order Adams-Bashforth-Moulton time integral
scheme is then used to evolve free surface and the rigid-body body
motions in time.
