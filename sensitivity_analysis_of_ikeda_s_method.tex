...
the linear part is dominating.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_43_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
to a square section, will have a great impact on the eddy roll damping.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_46_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
tree is illustrated in the figure below:
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_67_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\bottomrule 
 \end{longtable}
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_70_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
shown in the figure below.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_76_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
\(\phi_{n+2}\) * D : \((\phi_n + \phi_{n+1} + \phi_{n+2})/3\)
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_83_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
