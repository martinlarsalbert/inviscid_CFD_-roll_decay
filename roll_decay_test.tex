...
$B_e$ can be calculated as a Fourier series expansion of the damping
model, which in the case of a quadratic model yields as
...
\label{eq:B_1_zeta_eq}
\end{equation}
The roll amplitude is calculated as the mean value of the three peaks
used to obtain $B_n$:
