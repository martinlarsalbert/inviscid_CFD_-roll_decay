...
linear trend in the roll angle signal.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_91_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
better agreement.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_95_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
below.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_98_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
Replacing the wave damping $B_W$, for the zero speed case above, with values obtained with FNPF is shown below. 
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_101_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
from the model tests.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_103_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
...
similar results to the corresponding model tests.
    ...
    \begin{figure}
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{figures/output_105_0.pdf}\end{center}
        \caption{}
        \label{}
    \end{figure}
