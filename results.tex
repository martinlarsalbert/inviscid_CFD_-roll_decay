...
\quad     \subsection*{Roll decay model tests}\label{roll-decay-model-tests}

\quad \subsubsection*{Test at 0 knots}\label{test-at-0-knots}

\quad Two roll decay model tests were conducted at zero speed referred to as
Run 1 and 2.
...
\quad     \subsubsection*{Test at 15.5 knots}\label{test-at-15.5-knots}

\quad One roll decay model tests, referred to as Run 3, was conducted at a
...
\quad     The $C_r$ was calculated with regular Ikeda's method and the
...
\quad Simulations of roll decay tests were conducted with FNPF without viscous
...
\quad     In Fig.\ref{fig:ikeda} the wave damping $B_W$ was calculated
