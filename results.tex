...
\hline\addlinespace
$F_n$ & method & $B_1$ & $B_2$ & $B_{e5}$\\
$[-]$ &  & $[Nm \cdot s]$ & $[Nm \cdot s^2]$ & $[Nm \cdot s]$\\
\hline0.0 & model test & 0.54 & 14.95 & 3.26\\
0.0 & model test & 0.51 & 14.98 & 3.24\\
0.0 & hybrid & 1.2 & 14.5 & 3.84\\
0.14 & model test & 7.93 & 5.1 & 8.87\\
0.14 & hybrid & 7.52 & 6.01 & 8.61\\
\hline
\end{tabular}
\end{table}
