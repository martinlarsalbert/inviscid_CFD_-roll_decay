...
linear trend in the roll angle signal.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_89_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
better agreement.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_93_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
below.
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_96_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
...
Replacing the wave damping $B_W$, for the zero speed case above, with values obtained with FNPF is shown below. 
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{figures/output_99_0.pdf}
    \end{center}
    { \hspace*{\fill} \\}
