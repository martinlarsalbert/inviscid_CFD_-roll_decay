...
\quad     \subsection*{Lewis sections}\label{lewis-sections}

\quad     The Lewis section coefficients were calculated as:
...
\quad     \subsection*{KVLCC2}\label{kvlcc2}

\quad  The section table for KVLCC2 is shown in
