...
\cite{7505983/FB64RGPF}:
    ...
    \begin{equation}
A_{44} \ddot{\phi} + \operatorname{B_{44}}\left(\dot{\phi}\right)  \\ 
+ \operatorname{C_{44}}\left(\phi\right) = 0 \\ 
...
\end{equation}
    ...
    \begin{equation}
A_{44} \ddot{\phi} + B_{1} \dot{\phi}  \\ 
+ B_{2} \left|{\dot{\phi}}\right| \dot{\phi}  \\ 
+ B_{3} \dot{\phi}^{3}  \\ 
+ C_{1} \phi  \\ 
+ C_{3} \phi^{3}  \\ 
+ C_{5} \phi^{5} = 0 \\ 
...
unique solutions:
    ...
    \begin{equation}
B_{1A} \dot{\phi} + B_{2A} \left|{\dot{\phi}}\right| \dot{\phi}  \\ 
+ B_{3A} \dot{\phi}^{3}  \\ 
+ C_{1A} \phi  \\ 
+ C_{3A} \phi^{3}  \\ 
+ C_{5A} \phi^{5}  \\ 
