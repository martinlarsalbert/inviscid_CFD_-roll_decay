...
\nomenclature{$\displaystyle B_{1}$,$\displaystyle B_{2}$,$\displaystyle B_{3}$,$\displaystyle C_{1}$,$\displaystyle C_{3}$,$\displaystyle C_{5}$}{\nomunit{ }}
\nomenclature{$\displaystyle B_{1A}$}{damping helpers\nomunit{ }}
\nomenclature{$\displaystyle B_{2A}$}{damping helpers\nomunit{ }}
\nomenclature{$\displaystyle B_{3A}$}{damping helpers\nomunit{ }}
...
\nomenclature{$\displaystyle \hat{B^*}_{E}$}{only nonlinear nondimensional damping\nomunit{-}}
\nomenclature{$\displaystyle B_{s}$}{section beam\nomunit{m}}
\nomenclature{$\displaystyle C_{1A}$}{stiffness helpers\nomunit{ }}
\nomenclature{$\displaystyle C_{3A}$}{stiffness helpers\nomunit{ }}
\nomenclature{$\displaystyle C_{5A}$}{stiffness helpers\nomunit{ }}
...
\quad \printnomenclature

\quad     

\quad     % Add a bibliography block to the postdoc
